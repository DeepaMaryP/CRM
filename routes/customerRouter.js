...
import { validateCustomer, validateCustomerUpdate } from "../middleware/customerMiddleware.js";
...
router.route("/:custId").patch(handleAuth, validateCustomerUpdate, updateCustomer)
